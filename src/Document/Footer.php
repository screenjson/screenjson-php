...
class Footer extends Surface implements FooterInterface, JsonSerializable
{
    ...
    public function cover (?bool $value = null) : self | bool 
    {
        if ($value)
        {
            $this->cop->check ('Footer cover', $value, ['bool_type', 'bool_val']);
    ...
    public function display (?bool $value = null) : self | bool 
    {
        if ($value)
        {
            $this->cop->check ('Footer display', $value, ['bool_type', 'bool_val']);
    ...
    public function start (?int $value = null) : self | int 
    {
        if ($value)
        {
            $this->cop->check ('Footer start', $value, ['above_zero']);
